 ...
 */
public class BetterTrapezoidProfile extends TrapezoidProfile {
  ...
  /** Profile state. */
  public static class State extends TrapezoidProfile.State {
   ...
   */
  public BetterTrapezoidProfile(Constraints constraints) {
    super(constraints);
